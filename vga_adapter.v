...
module vga_adapter(
	...
	wire [((MONOCHROME == "TRUE") ? (0) : (BITS_PER_COLOR_CHANNEL*3-1)):0] to_ctrl_color;
	...
	altsyncram	VideoMemory (
				...
				.q_b (to_ctrl_color)	// data out
				);
	defparam
		VideoMemory.WIDTH_A = ((MONOCHROME == "FALSE") ? (BITS_PER_COLOR_CHANNEL*3) : 1),
		VideoMemory.WIDTH_B = ((MONOCHROME == "FALSE") ? (BITS_PER_COLOR_CHANNEL*3) : 1),
	...
	vga_controller controller(
		...
		defparam controller.BITS_PER_COLOR_CHANNEL  = BITS_PER_COLOR_CHANNEL ;
